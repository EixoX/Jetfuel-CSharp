...
namespace EixoX
{
    ...
    /// </summary>
    public interface IAspect : ICustomAttributeProvider
    {
        /// <summary>
        ...
        IEnumerable<IAspectMember> GetMembers();
        /// <summary>
        /// Gets an attribute.
        /// </summary>
