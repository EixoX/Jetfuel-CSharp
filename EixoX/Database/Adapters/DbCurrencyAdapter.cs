...
namespace EixoX.Adapters
{
    ...
    public class DbCurrencyAdapter : SimpleAdapterBase<Decimal>
    {
        ...
        public DbCurrencyAdapter(IFormatProvider formatProvider)
            : base(formatProvider) { }
        ...
        /// <param name="formatString">The format string to use.</param>
        /// <param name="formatProvider">The format provider to use.</param>
        public DbCurrencyAdapter(string formatString, IFormatProvider formatProvider)
