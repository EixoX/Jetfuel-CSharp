...
{
    /// <summary>
    /// Represents a simple type adapter for a UInt16.
    /// </summary>
    public class UInt16Adapter : SimpleAdapterBase<UInt16>
    {
        /// <summary>
        /// Creates a new UInt16 adapter base.
        /// </summary>
        public UInt16Adapter() { }

        /// <summary>
        /// Creates a new UInt16 adapter base with a given format string.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new UInt16 adapter base with a given format provider.
        /// </summary>
        /// <param name="formatProvider">The format provider to use.</param>
        public UInt16Adapter(IFormatProvider formatProvider)
            : base(formatProvider) { }

        /// <summary>
        /// Creates a simple UInt16 adapter base.
        /// </summary>
        /// <param name="formatString">The format string to use.</param>
        /// <param name="formatProvider">The format provider to use.</param>
        public UInt16Adapter(string formatString, IFormatProvider formatProvider)
        ...
        {
            get { return System.Data.DbType.UInt16; }
        }
        /// <summary>
        ...
        {
            get { return System.Data.SqlDbType.SmallInt; }
        }
        ...
        public override string FormatValue(UInt16 input, string formatString, IFormatProvider formatProvider)
        {
        ...
        public override UInt16 ParseValue(string input, IFormatProvider formatProvider)
        {
            return string.IsNullOrEmpty(input) ?
                (ushort)0 :
                UInt16.Parse(input, formatProvider);
        }
        ...
        public override string SqlMarshallValue(UInt16 input, bool nullable)
        {
            if (input == 0M)
                if (nullable)
                    return "NULL";
        ...
        /// <param name="nullable">Indicates that the input is nullable.</param>
        public override void SqlMarshallValue(StringBuilder builder, UInt16 input, bool nullable)
        {
            if (input == UInt16.MinValue)
                if (nullable)
                {
                    builder.Append("NULL");
                    return;
        ...
        public override UInt16 BinaryReadValue(BinaryReader reader)
        {
        ...
        public override void BinaryWriteValue(BinaryWriter writer, UInt16 value)
        {
            writer.Write(value);
        }
    }
