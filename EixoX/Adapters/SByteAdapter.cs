...
{
    /// <summary>
    /// Represents a simple type adapter for a SByte.
    /// </summary>
    public class SByteAdapter : SimpleAdapterBase<SByte>
    {
        /// <summary>
        /// Creates a new SByte adapter base.
        /// </summary>
        public SByteAdapter() { }

        /// <summary>
        /// Creates a new SByte adapter base with a given format string.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new SByte adapter base with a given format provider.
        /// </summary>
        /// <param name="formatProvider">The format provider to use.</param>
        public SByteAdapter(IFormatProvider formatProvider)
            : base(formatProvider) { }

        /// <summary>
        /// Creates a simple SByte adapter base.
        /// </summary>
        /// <param name="formatString">The format string to use.</param>
        /// <param name="formatProvider">The format provider to use.</param>
        public SByteAdapter(string formatString, IFormatProvider formatProvider)
        ...
        {
            get { return System.Data.DbType.SByte; }
        }
        /// <summary>
        ...
        public override string FormatValue(SByte input, string formatString, IFormatProvider formatProvider)
        {
        ...
        public override SByte ParseValue(string input, IFormatProvider formatProvider)
        {
            return string.IsNullOrEmpty(input) ?
                (sbyte)0 :
                SByte.Parse(input, formatProvider);
        }
        ...
        public override string SqlMarshallValue(SByte input, bool nullable)
        {
            if (input == 0)
                if (nullable)
                    return "NULL";
        ...
        /// <param name="nullable">Indicates that the input is nullable.</param>
        public override void SqlMarshallValue(StringBuilder builder, SByte input, bool nullable)
        {
        ...
        public override SByte BinaryReadValue(BinaryReader reader)
        {
        ...
        public override void BinaryWriteValue(BinaryWriter writer, SByte value)
        {
            writer.Write(value);
        }
    }
