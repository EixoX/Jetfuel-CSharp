...
{
    /// <summary>
    /// Represents a simple type adapter for a UInt64.
    /// </summary>
    public class UInt64Adapter : SimpleAdapterBase<UInt64>
    {
        /// <summary>
        /// Creates a new UInt64 adapter base.
        /// </summary>
        public UInt64Adapter() { }

        /// <summary>
        /// Creates a new UInt64 adapter base with a given format string.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new UInt64 adapter base with a given format provider.
        /// </summary>
        /// <param name="formatProvider">The format provider to use.</param>
        public UInt64Adapter(IFormatProvider formatProvider)
            : base(formatProvider) { }

        /// <summary>
        /// Creates a simple UInt64 adapter base.
        /// </summary>
        /// <param name="formatString">The format string to use.</param>
        /// <param name="formatProvider">The format provider to use.</param>
        public UInt64Adapter(string formatString, IFormatProvider formatProvider)
        ...
        {
            get { return System.Data.DbType.UInt64; }
        }
        /// <summary>
        ...
        {
            get { return System.Data.SqlDbType.BigInt; }
        }
        ...
        public override string FormatValue(UInt64 input, string formatString, IFormatProvider formatProvider)
        {
        ...
        public override UInt64 ParseValue(string input, IFormatProvider formatProvider)
        {
            return string.IsNullOrEmpty(input) ?
                0 :
                UInt64.Parse(input, formatProvider);
        }
        ...
        public override string SqlMarshallValue(UInt64 input, bool nullable)
        {
            if (input == 0)
                if (nullable)
                    return "NULL";
        ...
        /// <param name="nullable">Indicates that the input is nullable.</param>
        public override void SqlMarshallValue(StringBuilder builder, UInt64 input, bool nullable)
        {
            if (input == UInt64.MinValue)
                if (nullable)
                {
                    builder.Append("NULL");
                    return;
        ...
        public override UInt64 BinaryReadValue(BinaryReader reader)
        {
        ...
        public override void BinaryWriteValue(BinaryWriter writer, UInt64 value)
        {
            writer.Write(value);
        }
    }
